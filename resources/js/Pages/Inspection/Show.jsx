                        ...
                        <div className={"inline-flex space-x-8"}>
                            ...
                            <div className={"hidden sm:block space-x-4"}>
                                <Link href={"/inspection/edit/" + props.inspection.id}>
                                    <i className="fa fa-edit text-2xl" style={{color:"#d5d7dd"}}></i>
                                </Link>

                                <i className="fa fa-trash text-2xl" style={{color:"#ff7f7f"}}></i>
                            </div>
                        </div>
                    }
        >
                        ...
                        <div className="grid h-full overflow-y-hidden grid-flow-row-dense sm:grid-cols-2 lg:grid-cols-3 grid-rows-1 gap-x-24 gap-y-10 ">
                            <div className={"bg-primary-mid px-6 py-4 h-[14rem] rounded-lg shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)]"}>
                                ...
                                <p className={"text-4xl text-gray-200 font font-bold mb-6 underline"}>
                                    {props.inspection.component.type.charAt(0).toUpperCase() + props.inspection.component.type.slice(1)}
                                </p>
                                <h3 className={"text-m text-gray-400 font-bold mb-2"}>From</h3>
                                <Link href={"/turbine/" + props.inspection.component.turbine_id}>
                                    <p className={"text-4xl text-gray-200 font font-bold underline"}>Turbine #{props.inspection.component.turbine_id}</p>
                                </Link>


                            </div>
                            <div className="bg-primary-mid flex justify-center flex-col items-center px-6 py-4 rounded-lg shadow-md"
                                 style={{
                                        boxShadow: `
                                ...
                                <GradeGraphic gradeLevel={props.inspection.grade} height={"140px"} className={"pb-3 pt-2"}/>
                                <h3 className={"text-m text-gray-400 font-bold text-center"}>Grade Assigned</h3>
                            </div>
                            <div className={"bg-primary-mid px-6 py-4 rounded-lg shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] overflow-hidden hover:overflow-visible"}>
                                ...
                                <p className={"text-4xl text-gray-200 font font-bold mb-6"}>
                                    <DateConverter date={props.inspection.date} className={""}></DateConverter>
                                </p>
                            </div>
                            <div className={"bg-primary-mid px-6 h-[14rem] py-4 rounded-lg shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] overflow-hidden hover:overflow-visible"}>
                                <h3 className={"text-m text-gray-400 font-bold mb-2"}>Inspection Type</h3>
                                <p className={"text-4xl text-gray-200 font-bold mb-6 "}>
                                   <pre className={"font-sans"}>{props.inspection.type
                                                                                 .charAt(0)
                                                                                 .toUpperCase() + props.inspection.type
                                                                                 .slice(1)
                                                                                 .replace('_', ' ')
                                                                                 .replace(' ', '\n')
                                                                }
                            ...
                            <div className={"bg-primary-mid px-6 py-4 rounded-lg shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] overflow-hidden hover:overflow-visible"}>
                                ...
                                <p className={"text-4xl text-gray-200 font-bold mb-6 "}>
                                    <pre className={"font-sans"}>{props.inspection.user.name.replace(' ', '\n')}</pre>
                                </p>
                            </div>
                            <div className={"bg-primary-mid px-6 py-4 row-span-2 rounded-lg shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] overflow-hidden hover:overflow-visible"}>
                                <h3 className={"text-m text-gray-400 font-bold mb-2"}>Required Maintenance</h3>
                            </div>
                            <div className={"bg-primary-mid px-6 h-[14rem] py-4 sm:col-span-2  rounded-lg shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] overflow-hidden hover:overflow-visible"}>
