                    ...
                    <div
                        ...
                        <div
                            ...
                            <div
                                ...
                                {(props.turbines_needing_attention.turbines.length !== 0) ? (
                                props.turbines_needing_attention.turbines.map(
                                    ...
                                    {props.farm.turbines.map((item, index) => (
                                        ...
                                        <tr className={'odd:bg-primary-light text-gray-300 py-6'}
                                            ...
                                            <td className={'p-2'}><Link
                                                href={'/turbine/' +
                                                    item.id}>{item.id}</Link>
                                            </td>
                                            <td><Link href={'/turbine/' +
