...
export default function Edit(props) {
    ...
    const {data, setData, post, processing, errors} = useForm({
        ...
        phone_number: props.manufacturer.phone_number,
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('manufacturer.update'));
    };
    ...
    return (<AuthenticatedLayout
        ...
        header={<div className={'inline-flex space-x-6'}>
            <h2>Edit Manufacturer #{props.manufacturer.id}</h2>
        </div>}
    >
        <Head title={'Edit Manufacturer #' + props.manufacturer.id}/>
        <div className="py-6">
