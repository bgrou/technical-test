                ...
                <table className="table-auto w-full">
                    ...
                    {!loading ? (
                        data.map((d, index) => {
                            ...
                            return (
                                <tr className={"even:bg-primary-light"} key={index}>
                                    {columns.map((column) => {
                                        const value = column.includes('.') ? _.get(d, column) : d[column];
                                        const needDateConversion = column.includes('date') || column.includes('_at');

                                        return (
                                        <td key={column} className="px-4 py-2 text-gray-100">
                                    ...
                                    <td className={"px-6 space-x-2"}>
                                        <Link href={'/' + fetchUrl.split('/')[1].replace(/s$/, "") + '/' + d['id']}>
                                            <i className="fa fa-eye text-lg" style={{color:"#d5d7dd"}}></i>
                                        </Link>
                                        <Link href={'/' + fetchUrl.split('/')[1].replace(/s$/, "") + '/edit/' + d['id']}>
                                            <i className="fa fa-edit text-lg" style={{color:"#d5d7dd"}}></i>
                                        </Link>
                                        <i className="fa fa-trash text-lg" style={{color:"#ff7f7f"}}></i>
                                    </td>
                                </tr>
                            );
                        })
